...
5. Write `docs/current/code_review_v<N>.md`, `test_review_v<N>.md`, and the
   evaluator rubric using the supplied templates. Stop and present findings;
   the user decides whether accepted findings need a fix.
